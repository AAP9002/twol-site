    ...
    <ul class="timeline">
      ...
      <li>
        <div class="direction-l">
          ...
          <div class="desc">
            <p>This Way Of Life Feature Film - Sizzle Reel<br/>
                Behind the scene stills of the sizzle reel for the upcoming feature with supporting track Umm from the forthcoming Album.</p>
